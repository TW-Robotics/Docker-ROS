...
docker run -it --rm --network bridge  -p 5000:5000 --mount type=bind,source="%pfad%\",target=/home/fhtw_user/catkin_ws/src/ --name "fhtw_ros" --privileged -e DISPLAY=%DISPLAY%  "georgno/fhtw-ros:latest" "bash"
